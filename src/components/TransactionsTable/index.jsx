...
function TransactionsTable({ transactions ,addTransaction ,fetchTransactions }) {
  ...
  let FilteredTransaction = transactions.filter((item) => item.name.toLowerCase().includes(search.toLowerCase()));
  ...
  return (
    ...
    >
      ...
      <Select onChange={(value) => setTypeFilter(value)} value={typeFilter} allowClear placeholder="Filter">
